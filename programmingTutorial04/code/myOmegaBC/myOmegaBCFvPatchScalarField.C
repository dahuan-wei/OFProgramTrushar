...
myOmegaBCFvPatchScalarField::myOmegaBCFvPatchScalarField
(
    const fvPatch& p,
...
myOmegaBCFvPatchScalarField::myOmegaBCFvPatchScalarField
(
    const myOmegaBCFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    y_(dict.lookup("y"))
{
    ...
    {
        FatalErrorIn("myOmegaBCFvPatchScalarField(dict)")
...
myOmegaBCFvPatchScalarField::myOmegaBCFvPatchScalarField
(
    const myOmegaBCFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void myOmegaBCFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
  ...
  //  vector ctr = 0.5*(bb.max() + bb.min());
   ...
   // scalarField coord = 2*((c - ctr) & y_)/((bb.max() - bb.min()) & y_);
    ...
    scalarField omega = epsilon/(TKE*0.09);  
...
// Write
void myOmegaBCFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, myOmegaBCFvPatchScalarField);
