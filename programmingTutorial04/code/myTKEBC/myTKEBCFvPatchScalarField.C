...
myTKEBCFvPatchScalarField::myTKEBCFvPatchScalarField
(
    const fvPatch& p,
    ...
    y_(dict.lookup("y"))
{
    ...
    {
        FatalErrorIn("myTKEBCFvPatchScalarField(dict)")
...
myTKEBCFvPatchScalarField::myTKEBCFvPatchScalarField
(
    const myTKEBCFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void myTKEBCFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void myTKEBCFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, myTKEBCFvPatchScalarField);
